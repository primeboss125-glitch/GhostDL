...
curl -sL https://raw.githubusercontent.com/primeboss125-glitch/GhostDL/main/app.py -o ~/app.py
curl -sL https://raw.githubusercontent.com/primeboss125-glitch/GhostDL/main/Index.html -o ~/index.html
